...
if setting_name == "Q3p85_W2p62_t0p21":
    #RF cut Efficiency
    RF_efficiency = 0.9985
    RF_efficiency_error = 0.00006
    ...
    #RF cut Efficiency
    RF_efficiency = 0.9985
    RF_efficiency_error = 0.00005
    # Pion Absorption Correction
    pion_absorption_correction = 0.9546
    pion_absorption_correction_error = 0.00006
else:
...
#MMpi_pions_simc_cut_all.Scale(match_scale)
...
if MMpi_pions_simc_cut_all.GetMaximum() > MMpi_pions_normdummysub_data_cut_all.GetMaximum():
    MMpi_pions_simc_cut_all.Draw("E1")
    MMpi_pions_normdummysub_data_cut_all.Draw("E1same")
else:
    MMpi_pions_normdummysub_data_cut_all.Draw("E1")
    MMpi_pions_simc_cut_all.Draw("E1same")
...
#W_pions_simc_cut_all.Scale(match_scale)
...
if W_pions_simc_cut_all.GetMaximum() > W_pions_normdummysub_data_cut_all.GetMaximum():
    W_pions_simc_cut_all.Draw("E1")
    W_pions_normdummysub_data_cut_all.Draw("E1same")
else:
    W_pions_normdummysub_data_cut_all.Draw("E1")
    W_pions_simc_cut_all.Draw("E1same")
# Legend for W plot
...
#t_pions_simc_cut_all.Scale(match_scale)
...
if t_pions_simc_cut_all.GetMaximum() > t_pions_normdummysub_data_cut_all.GetMaximum():
    t_pions_simc_cut_all.Draw("E1")
    t_pions_normdummysub_data_cut_all.Draw("E1same")
else:
    t_pions_normdummysub_data_cut_all.Draw("E1")
    t_pions_simc_cut_all.Draw("E1same")
# Legend for t plot
...
#Q2_pions_simc_cut_all.Scale(match_scale)
...
if Q2_pions_simc_cut_all.GetMaximum() > Q2_pions_normdummysub_data_cut_all.GetMaximum():
    Q2_pions_simc_cut_all.Draw("E1")
    Q2_pions_normdummysub_data_cut_all.Draw("E1same")
else:
    Q2_pions_normdummysub_data_cut_all.Draw("E1")
    Q2_pions_simc_cut_all.Draw("E1same")
# Legend for Q² plot
...
#phipq_pions_simc_cut_all.Scale(match_scale)
...
if phipq_pions_simc_cut_all.GetMaximum() > ph_q_pions_normdummysub_data_cut_all.GetMaximum():
    phipq_pions_simc_cut_all.Draw("E1")
    ph_q_pions_normdummysub_data_cut_all.Draw("E1same")
else:
    ph_q_pions_normdummysub_data_cut_all.Draw("E1")
    phipq_pions_simc_cut_all.Draw("E1same")
# Legend for phi Plot
...
#H_hsdelta_pions_simc_cut_all.Scale(match_scale)
...
if H_hsdelta_pions_simc_cut_all.GetMaximum() > H_gtr_dp_pions_normdummysub_data_cut_all.GetMaximum():
    H_hsdelta_pions_simc_cut_all.Draw("E1")
    H_gtr_dp_pions_normdummysub_data_cut_all.Draw("E1same")
else:
    H_gtr_dp_pions_normdummysub_data_cut_all.Draw("E1")
    H_hsdelta_pions_simc_cut_all.Draw("E1same")
...
#P_ssdelta_pions_simc_cut_all.Scale(match_scale)
...
if P_ssdelta_pions_simc_cut_all.GetMaximum() > P_gtr_dp_pions_normdummysub_data_cut_all.GetMaximum():
    P_ssdelta_pions_simc_cut_all.Draw("E1")
    P_gtr_dp_pions_normdummysub_data_cut_all.Draw("E1same")
else:
    P_gtr_dp_pions_normdummysub_data_cut_all.Draw("E1")
    P_ssdelta_pions_simc_cut_all.Draw("E1same")
...
#H_hsxptar_pions_simc_cut_all.Scale(match_scale)
...
if H_hsxptar_pions_simc_cut_all.GetMaximum() > H_gtr_xp_pions_normdummysub_data_cut_all.GetMaximum():
    H_hsxptar_pions_simc_cut_all.Draw("E1")
    H_gtr_xp_pions_normdummysub_data_cut_all.Draw("E1same")
else:
    H_gtr_xp_pions_normdummysub_data_cut_all.Draw("E1")
    H_hsxptar_pions_simc_cut_all.Draw("E1same")
...
#P_ssxptar_pions_simc_cut_all.Scale(match_scale)
...
if P_ssxptar_pions_simc_cut_all.GetMaximum() > P_gtr_xp_pions_normdummysub_data_cut_all.GetMaximum():
    P_ssxptar_pions_simc_cut_all.Draw("E1")
    P_gtr_xp_pions_normdummysub_data_cut_all.Draw("E1same")
else:
    P_gtr_xp_pions_normdummysub_data_cut_all.Draw("E1")
    P_ssxptar_pions_simc_cut_all.Draw("E1same")
...
#H_hsyptar_pions_simc_cut_all.Scale(match_scale)
...
if H_hsyptar_pions_simc_cut_all.GetMaximum() > H_gtr_yp_pions_normdummysub_data_cut_all.GetMaximum():
    H_hsyptar_pions_simc_cut_all.Draw("E1")
    H_gtr_yp_pions_normdummysub_data_cut_all.Draw("E1same")
else:
    H_gtr_yp_pions_normdummysub_data_cut_all.Draw("E1")
    H_hsyptar_pions_simc_cut_all.Draw("E1same")
...
#P_ssyptar_pions_simc_cut_all.Scale(match_scale)
...
if P_ssyptar_pions_simc_cut_all.GetMaximum() > P_gtr_yp_pions_normdummysub_data_cut_all.GetMaximum():
    P_ssyptar_pions_simc_cut_all.Draw("E1")
    P_gtr_yp_pions_normdummysub_data_cut_all.Draw("E1same")
else:
    P_gtr_yp_pions_normdummysub_data_cut_all.Draw("E1")
    P_ssyptar_pions_simc_cut_all.Draw("E1same")
...
#pmiss_y_pions_simc_cut_all.Scale(match_scale)
...
if pmiss_y_pions_simc_cut_all.GetMaximum() > pmiss_y_pions_normdummysub_data_cut_all.GetMaximum():
    pmiss_y_pions_simc_cut_all.Draw("E1")
    pmiss_y_pions_normdummysub_data_cut_all.Draw("E1same")
else:
    pmiss_y_pions_normdummysub_data_cut_all.Draw("E1")
    pmiss_y_pions_simc_cut_all.Draw("E1same")
...
#pmiss_z_pions_simc_cut_all.Scale(match_scale)
...
if pmiss_z_pions_simc_cut_all.GetMaximum() > pmiss_z_pions_normdummysub_data_cut_all.GetMaximum():
    pmiss_z_pions_simc_cut_all.Draw("E1")
    pmiss_z_pions_normdummysub_data_cut_all.Draw("E1same")
else:
    pmiss_z_pions_normdummysub_data_cut_all.Draw("E1")
    pmiss_z_pions_simc_cut_all.Draw("E1same")
...
#pmiss_pions_simc_cut_all.Scale(match_scale)
...
if pmiss_pions_simc_cut_all.GetMaximum() > pmiss_pions_normdummysub_data_cut_all.GetMaximum():
    pmiss_pions_simc_cut_all.Draw("E1")
    pmiss_pions_normdummysub_data_cut_all.Draw("E1same")
else:
    pmiss_pions_normdummysub_data_cut_all.Draw("E1")
    pmiss_pions_simc_cut_all.Draw("E1same")
...
#emiss_pions_simc_cut_all.Scale(match_scale)
...
if emiss_pions_simc_cut_all.GetMaximum() > emiss_pions_normdummysub_data_cut_all.GetMaximum():
    emiss_pions_simc_cut_all.Draw("E1")
    emiss_pions_normdummysub_data_cut_all.Draw("E1same")
else:
    emiss_pions_normdummysub_data_cut_all.Draw("E1")
    emiss_pions_simc_cut_all.Draw("E1same")
